...
import {
  salesforceSoftwareEngineerMetadata,
  salesforceSoftwareEngineerProjects,
  salesforceSoftwareEngineerSkills,
  salesforceSoftwareEngineerSummary,
} from '../shared/salesforceSoftwareEngineer.js'

const certificationItems = certifications.map(({ id, issuer, name }) => ({ id, issuer, name }))

export default Object.freeze({
  id: 'salesforce-software-engineer',
  label: 'Salesforce Software Engineer',
  locale: 'en-US',
  status: 'published',
  metadata: salesforceSoftwareEngineerMetadata,
  labels: {
    present: 'Present',
  },
  header: {
  ...
  summary: salesforceSoftwareEngineerSummary,
  sections: [
    {
      id: 'technical-skills',
      type: 'skills',
      ...
      items: salesforceSoftwareEngineerSkills,
    },
    {
      ...
      items: salesforceSoftwareEngineerProjects,
    },
    {
      id: 'certifications',
      type: 'certifications',
